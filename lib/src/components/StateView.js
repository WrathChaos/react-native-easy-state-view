	...
	render() {
		...
		return (
			<View style={style || { top: 0 }}>
				<CachedImage
					style={[(imageStyle || { width: 150, height: 200 }), isCenter && styles.center]}
				...
				<Text style={[(isCenter && styles.center), subtitleStyle || styles.subTitleStyle]}>
					{subtitle || "We could not reach the internet, try to check your network and let's try again :)"}
				</Text>
			</View>
		);
	}
